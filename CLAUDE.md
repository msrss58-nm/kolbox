...
## Budget module ("ניהול תקציב") - Stages 1-6 + 7A CLOSED / PASS (Stages 3-7A LOCAL only)

Stages 3 (Budget Core), 4 (Documents & Supplier Workflow), 5 (Party Funding Workflow), 6 (Dashboard, Reports & Controls) and 7A (Integration, Security & Release Readiness) are local commits only - NOT pushed, NOT deployed, their nine migrations (`20260917000000`/`010000`/`020000`, `20260918000000`/`010000`, `20260919000000`/`010000`, `20260920000000`, `20260921000000`) NOT applied to Production, Budget not activated anywhere. Stage 7B (Production rollout: push -> migrations -> deploy -> controlled activation -> acceptance -> closure) is NOT STARTED; each of its six gates needs its own explicit approval - the gate plan and the acceptance checklist are in `CURRENT_STATUS.md`'s Stage 7A section. Approved design: `CURRENT_STATUS.md`'s Budget section; the Stage 3-7A build records follow it - do not re-derive or reopen them.
