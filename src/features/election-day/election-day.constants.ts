...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  "budget.view": "ניהול תקציב - צפייה",
  "budget.manageExpenses": "ניהול תקציב - הוצאות ותשלומים",
  "budget.manageFunderSubmissions": "ניהול תקציב - הגשות למממן",
  "budget.manageSuppliers": "ניהול תקציב - ספקים ופרטי בנק",
  "budget.managePlan": "ניהול תקציב - תקציב ותכנון",
  "budget.viewReports": "ניהול תקציב - דוחות",
  "budget.manageSettings": "ניהול תקציב - הגדרות",
