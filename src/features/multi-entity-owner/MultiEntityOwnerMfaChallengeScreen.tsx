...
/**
 * Platform Stage 5: the TOTP challenge - the ONLY screen reachable while the
 * Multi-Entity session is at aal1 WITH a verified factor. Rendered directly by
 * `MultiEntityOwnerAuthGuard`; never enrolls anything.
 */
export function MultiEntityOwnerMfaChallengeScreen() {
