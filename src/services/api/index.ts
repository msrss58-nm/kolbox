...
export const api: ApiClient = {
  ...
  closeReminder: (...args) => electionDayApi.closeReminder(...args),
  cancelReminder: (...args) => electionDayApi.cancelReminder(...args),
  listReminderEvents: (...args) => electionDayApi.listReminderEvents(...args),
