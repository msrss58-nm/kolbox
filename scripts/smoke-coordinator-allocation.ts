...
const ERROR_CODE_EXPECTATIONS: [string, string][] = [
  ...
  [
    "DISPLAY_NAME_LOCKED",
    "לא ניתן לשנות את שם הרכז - יש לו בוחרים משויכים כרגע או שהוא כבר השתתף בפעילות הקצאות בעבר",
  ],
  ["ASSIGNMENT_ALREADY_LINKED", "המחרוזת המקושרת כבר משויכת לרכז אחר"],
  [
    "COORDINATOR_HAS_ASSIGNED_VOTERS",
    "לא ניתן להסיר רכז שיש לו בוחרים משויכים כרגע - יש להעביר את ההקצאות תחילה (העבר הקצאות)",
  ],
  [
    "COORDINATOR_HAS_LOGIN_ACCOUNT",
    "לא ניתן להסיר רכז זה - קיים חשבון התחברות התלוי בשם זהות זה, יש לטפל בשיוך המשתמש תחילה",
  ],
  [
    "COORDINATOR_LOCKED",
    "לא ניתן לבצע פעולה זו על רכז שכבר השתתף בפעילות הקצאות - ניתן להשתמש ב'סיום פעילות' עבור רכז זה",
  ],
